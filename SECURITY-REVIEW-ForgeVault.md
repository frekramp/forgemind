...
> Note: `forge` isn't available in this sandbox, so tests were read but not executed. Run `forge test` locally to confirm the suite is green, and add the reentrancy test from #5.
